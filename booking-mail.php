...
<div class="invoice-container">
    <div class="header">
        <img src="https://jollytourism.com/assets/img/logo/logo.png" class="logo" alt="Logo" height="50">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="total-row">
                <td colspan="3" style="text-align:right;">Platform Charges (2%)</td>
                <td style="text-align:right;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span><?php echo $p_charge; ?></td>
            </tr>
            <tr class="total-row">
...
//Recipients
   ...
   header("Location: ../booking-success?bid=$book_ids");
