  ...
  <body> 
                ...
                <div class="card">
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          <?php
                          $query3  = "SELECT * FROM tb_activitiy_date WHERE  status = 1 ORDER BY updated_log DESC";
                          ...
                          <tr>
                            ...
                            <td class="text-center"><button class="btn btn-success btn-sm inactive" id="inactive" data-id="<?php echo $act_dateid; ?>"><i class="fa fa-check fa-lg"></i></button></td>
    ...
    $(".inactive").click(function() {
        ...
        var type = "active";
            swal({
              title: "Are you sure?",
              text: "You want to active this date!",
              icon: "warning",
              buttons: true,
            dangerMode: true,
          }).then((willDelete) => {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data === 'done') {
                    swal({
                        title: "Active!",
                        text: "Activity date has been added.",
                        icon: "success"
                    }).then(function() {
                        location.reload();
                    });
