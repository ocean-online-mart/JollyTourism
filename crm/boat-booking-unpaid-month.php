        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Boating Adventure Booking Unpaid - <?php echo date('F'); ?>  Month</h4>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
                  ...
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          <?php
                          $today_date= date('m');
                          $query3  = "SELECT * FROM tb_booking WHERE mc_id = 1 AND status=0 AND payment=0 AND month(updated_log) = '$today_date' ORDER BY updated_log DESC";
