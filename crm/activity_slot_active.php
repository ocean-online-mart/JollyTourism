  ...
  <body> 
                  ...
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          <?php
                          $time = date('H:i');
                          $query3  = "SELECT * FROM tb_activitiy_date WHERE date(act_date) >='$today_date' AND status !=1 ORDER BY updated_log DESC";
                          ...
                          $slot_query = "SELECT * FROM tb_activity_slot WHERE status=0 AND actdate_id ='$act_dateid' {$date_compare} ";
                          ...
                          <tr>
                            ...
                            <td class="text-center"><button class="btn btn-danger btn-sm inactive" id="inactive" data-id="<?php echo $slot_id; ?>"><i class="fa fa-trash fa-lg"></i></button></td>
    ...
    $(".inactive").click(function() {
        ...
        var type = "delete";
            swal({
              title: "Are you sure?",
              text: "You want to inactive this slot!",
              icon: "warning",
              buttons: true,
            dangerMode: true,
          }).then((willDelete) => {
        ...
        $.ajax({
            ...
            type: "POST",
            data: { "slot_id": slot_id, "type": type },
            dataType: "json",
            success: function(data) {
                if (data === 'done') {
                    swal({
                        title: "Inactive!",
                        text: "Slot date has been inactivated.",
                        icon: "success"
                    }).then(function() {
                        location.reload();
                    });
