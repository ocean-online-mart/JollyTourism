        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Tour Package Booking Unpaid - Yesterday (<?php echo date('d M Y',strtotime("-1 days")); ?>)</h4>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Tour Package Booking</li>
                  </ol>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          ...
                          $query3  = "SELECT * FROM tb_booking WHERE mc_id = 3 AND status=0 AND payment=0 AND date(updated_log) = '$today_date' ORDER BY updated_log DESC";
