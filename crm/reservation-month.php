        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Reservation - <?php echo date('F'); ?>  Month</h4>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
                  ...
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          <?php
                          $today_date= date('m');
                          $query3  = "SELECT * FROM tb_booking WHERE status=1 AND payment=1 AND month(act_date) = '$today_date' ORDER BY updated_log DESC";
