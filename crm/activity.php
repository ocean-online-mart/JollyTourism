                ...
                <div class="card">
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          <?php
                          $query3  = "SELECT * FROM tb_activities ORDER BY updated_log DESC";
                          $res_query3 = mysqli_query($conn,$query3);
                          $counter=0;
                          while($fetch3 = mysqli_fetch_object($res_query3))
                          {
                          $counter++;
                          $activity_id=$fetch3->activity_id;
                          $mc_id=$fetch3->mc_id;
                          $activity_name=$fetch3->activity_name;
                          $duration=$fetch3->duration;
                          ...
                          <tr>
                            ...
                            <td class="text-center d-flex gap-2">
                              ...
                              <button data-bs-toggle="modal" data-bs-target="#editmodal" class="btn openModal btn-primary btn-sm inactive" id="inactive" data-id="<?php echo $mc_id; ?>"><i class="fa fa-edit fa-lg"></i></button> 
                              <button class="btn btn-danger btn-sm inactive" id="inactive" data-id="<?php echo $mc_id; ?>"><i class="fa fa-trash fa-lg"></i></button>
                            </td>
...
<script type="text/javascript">
  $('.openModal').click(function(){
      ...
      console.log(id);
      $.ajax({url:"activityedit_model.php?id="+id,cache:false,success:function(result){
