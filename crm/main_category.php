                ...
                <div class="card">
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          <?php
                          $query3  = "SELECT * FROM tb_main_catagory ORDER BY updated_log DESC";
                          ...
                          $counter++;
                          $mc_id=$fetch3->mc_id;
                          $mc_name=$fetch3->mc_name;
                          $mc_image=$fetch3->mc_image;
                          $mc_description=$fetch3->mc_description;
                          ...
                          <tr>
                            ...
                            <td><?php echo $mc_description; ?></td>
                            <td class="text-center"><button class="btn btn-primary btn-sm inactive" id="inactive" data-id="<?php echo $mc_id; ?>"><i class="fa fa-edit fa-lg"></i></button> <button class="btn btn-danger btn-sm inactive" id="inactive" data-id="<?php echo $mc_id; ?>"><i class="fa fa-trash fa-lg"></i></button></td>
