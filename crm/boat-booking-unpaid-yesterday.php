  ...
  <body> 
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Boating Adventure Booking Unpaid - Yesterday (<?php echo date('d M Y',strtotime("-1 days")); ?>)</h4>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Boating Adventure Booking</li>
                  </ol>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          ...
                          $query3  = "SELECT * FROM tb_booking WHERE mc_id = 1 AND status=0 AND payment=0 AND date(updated_log) = '$today_date' ORDER BY updated_log DESC";
                          ...
                          <tr>
                            ...
                            <td><b>#JT31052500<?php echo $booking_id; ?> </b><br><?php echo $booking_type; ?></td>
                            <td><a href="#customerModal" data-bs-toggle="modal" data-bs-target="#customerModal" class="openModal3" data-bookid="<?php echo $booking_id; ?>" ><?php echo $cus_name; ?> </a><br><b><?php echo $phone_no; ?></b></td>
                            <td><?php echo $activity_name; ?></td>
                            <td><?php echo $acti_date; ?> <br><?php echo $slot_name; ?></td>
                            <td><b><?php echo $adult; ?></b> Adult <b><?php echo $children; ?></b> Children</td>
                            <td><b>₹<?php echo $total_amounts - $discount; ?></b> (<?php echo $payment_type; ?>)<br><a href="#descriptionModal" data-bs-toggle="modal" data-bs-target="#descriptionModal" class="openModal2 text-danger fw-bold" data-bid="<?php echo $booking_id; ?>" >Unpaid</a></td>
       ...
       <!-- view model -->
       <div class="modal fade"  id="descriptionModal" tabindex="-1" role="dialog" aria-labelledby="descriptionModalLabel" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
      ...
      <div class="modal fade"  id="customerModal" tabindex="-1" role="dialog" aria-labelledby="customerModalLabel" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
        <div class="modal-dialog modal-md" role="document">
          <div class="modal-content customer-content">               
    ...
    <script type="text/javascript">
      $('.openModal2').click(function(){
          ...
          $.ajax({url:"payment_model.php?id="+id,cache:false,success:function(result){
    ...
    <script type="text/javascript">
      $('.openModal3').click(function(){
          ...
          $.ajax({url:"customer_model.php?id="+id,cache:false,success:function(result){
              $(".customer-content").html(result);
          }});
      });
    </script>
  </body>
