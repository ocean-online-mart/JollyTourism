        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Customer - <?php echo date('F'); ?>  Month</h4>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
                  ...
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          ...
                          $today_date= date('m');
                          $total = 0;
                          $query3  = "SELECT *,MAX(booking_id) AS max_booking_id FROM tb_booking WHERE month(updated_log) = '$today_date'  GROUP BY phone_no ORDER BY booking_id DESC ";
