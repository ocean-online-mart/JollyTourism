        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Boating & Package Booking Paid - Yesterday (<?php echo date('d M Y',strtotime("-1 days")); ?>)</h4>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
                  ...
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          ...
                          $query3  = "SELECT * FROM tb_booking WHERE status=1 AND payment=1 AND date(updated_log) = '$today_date' ORDER BY updated_log DESC";
