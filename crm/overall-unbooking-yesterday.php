        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Boating & Package Booking Unpaid - Yesterday (<?php echo date('d M Y',strtotime("-1 days")); ?>)</h4>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Boating & Package Booking</li>
                  </ol>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          ...
                          $query3  = "SELECT * FROM tb_booking WHERE status=0 AND payment=0 AND date(updated_log) = '$today_date' ORDER BY updated_log DESC";
                          ...
                          <tr>
                            ...
                            <td><b>₹<?php echo $amount_recieved; ?></b> (<?php echo $payment_type; ?>)<br><a href="#descriptionModal" data-bs-toggle="modal" data-bs-target="#descriptionModal" class="openModal2 text-danger fw-bold" data-bid="<?php echo $booking_id; ?>" >Unpaid</a></td>
