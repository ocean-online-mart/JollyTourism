        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Boating Adventure Booking Paid - Yesterday (<?php echo date('d M Y',strtotime("-1 days")); ?>)</h4>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
                  ...
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          ...
                          $query3  = "SELECT * FROM tb_booking WHERE mc_id = 1 AND status=1 AND payment=1 AND date(updated_log) = '$today_date' ORDER BY updated_log DESC";
                          ...
                          <tr>
                            ...
                            <td><b>₹<?php echo $amount_recieved; ?></b> (<?php echo $payment_type; ?>)<br><a href="#descriptionModal" data-bs-toggle="modal" data-bs-target="#descriptionModal" class="openModal2 text-success fw-bold" data-bid="<?php echo $booking_id; ?>" >Paid</a></td>
