$(document).ready(function() {
    ...
    $('input[type="number"]').tooltipster({ //find more options on the tooltipster page
        trigger: 'click', // default is 'hover' which is no good here
        position: 'top',
        clickOutside : true,
        animation: 'grow'
    ...
    $('input[type="time"]').tooltipster({ //find more options on the tooltipster page
        trigger: 'click', // default is 'hover' which is no good here
        position: 'top',
        clickOutside : true,
        animation: 'grow'
    });
    $('input[type="radio"]').tooltipster({ //find more options on the tooltipster page
        trigger: 'click', // default is 'hover' which is no good here
        position: 'top',
        clickOutside : true,
        animation: 'grow'
    });
    $('input[type="checkbox"]').tooltipster({ //find more options on the tooltipster page
        trigger: 'click', // default is 'hover' which is no good here
        position: 'top',
        clickOutside : true,
        animation: 'grow'
    });
    $('input[type="file"]').tooltipster({ //find more options on the tooltipster page
        trigger: 'click', // default is 'hover' which is no good here
        position: 'top',
        clickOutside : true,
        animation: 'grow'
    });
    $('select[type="text"]').tooltipster({ //find more options on the tooltipster page
        trigger: 'click', // default is 'hover' which is no good here
        position: 'top',
        clickOutside : true,
        animation: 'grow'
    });
    $('textarea[type="text"]').tooltipster({ //find more options on the tooltipster page
        trigger: 'click', // default is 'hover' which is no good here
        position: 'top',
        clickOutside : true,
        animation: 'grow'
