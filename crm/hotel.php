                ...
                <div class="card">
                  <div class="card-body">
                      <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" table-layout="auto">
                        ...
                        <tbody>
                          <?php
                          $query3  = "SELECT * FROM tb_stay ORDER BY updated_log DESC";
                          $res_query3 = mysqli_query($conn,$query3);
                          $counter=0;
                          while($fetch3 = mysqli_fetch_object($res_query3))
                          {
                          $counter++;
                          $stay_id=$fetch3->stay_id;
                          $stay_name=$fetch3->stay_name;
                          $stay_description=$fetch3->stay_description;
                          $price=$fetch3->price;
                          ...
                          <tr>
                            ...
                            <td><?php echo $stay_name; ?></td>
                            <td><?php echo $stay_description; ?></td>
                            <td>₹<?php echo $price; ?></td>
                            <td class="text-center"><button class="btn btn-primary btn-sm inactive" id="inactive" data-id="<?php echo $mc_id; ?>"><i class="fa fa-edit fa-lg"></i></button> <button class="btn btn-danger btn-sm inactive" id="inactive" data-id="<?php echo $stay_id; ?>"><i class="fa fa-trash fa-lg"></i></button></td>
