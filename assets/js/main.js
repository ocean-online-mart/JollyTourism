! function(e) {
    ...
    if (e(window).on("load", (function() {
            ...
            e(this).scrollTop() > 1200 ? (e(".sticky-wrapper").addClass("sticky"), e(".category-menu").addClass("close-category")) : (e(".sticky-wrapper").removeClass("sticky"), e(".category-menu").removeClass("close-category"))
    ...
    function f() {
        ...
        (function() {
            ...
            function i(i) {
                i = i.split(",");
                for (var n = 0; n < i.length; n++) t = p + " " + i[n], e(t).val() ? (e(t).removeClass("is-invalid"), a = !0) : (e(t).addClass("is-invalid"), a = !1)
            }
            ...
            h.removeClass("error"), h.addClass("success"), h.text(t), e(p + ' input:not([type="submit"]),' + p + " textarea").val("")
        })).fail((function(e) {
    ...
    if (e(".cursor-follower").length > 0) {
        ...
        TweenMax.to({}, .016, {
            repeat: -1,
            onRepeat: function() {
                v += (b - v) / 9, w += (y - w) / 9, TweenMax.set(m, {
                    css: {
                        left: v - 12,
                        top: w - 12
                    }
    ...
    window.addEventListener("pointermove", e => {
        ...
        e(this).each((function() {
            ...
            i = Math.floor(l.height() / 2), n = l.attr(t), s = l.attr(a), o = T(e(s).css("padding-top")), r = T(e(s).css("padding-bottom")), "top-half" === n ? (e(s).css("padding-bottom", r + i + "px"), l.css("margin-top", "-" + i + "px")) : "bottom-half" === n && (e(s).css("padding-top", o + i + "px"), l.css("margin-bottom", "-" + i + "px"))
        }))
    };
    ...
    })), B(), e(window).scroll(B), e(".filter-active").imagesLoaded((function() {
    ...
    e.fn.lettering = function(t) {
        return t && E[t] ? E[t].apply(this, [].slice.call(arguments, 1)) : "letters" !== t && t ? (e.error("Method " + t + " does not exist on jQuery.lettering"), this) : E.init.apply(this, [].slice.call(arguments, 0))
    }, e(".discount-anime").lettering(), e("#ship-to-different-address-checkbox").on("change", (function() {
