                        ...
                        <div class="tour-snapshot mt-4">
                           <div class="tour-snap-wrapp">
                              ...
                              <div class="tour-snap">
                                 ...
                                 <div class="content"><span class="title">Boat Seat</span> <span><?php echo $seater; ?></span></div>
                              </div>
                              <div class="tour-snap">
                              ...
                              <div class="row align-items-center justify-content-between">
                                 ...
                                 <div class="form-group col-md-12">
                                    ...
                                    <div class="search-input">
                                       ...
                                       <select name="children" id="children" class="form-select nice-select" <?php echo $inactive; ?>>
