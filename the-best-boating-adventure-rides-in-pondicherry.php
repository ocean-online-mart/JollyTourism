            ...
            <div class="row">
               <div class="col-lg-6 offset-lg-3">
                  <div class="title-area text-center">
                     ...
                     <h2 class="sec-title">Boating Adventures</h2>
                     <p class="sec-text">Experience the thrill of the sea with Jolly Tourism’s Boating Adventure and create unforgettable memories on the water!</p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="row gy-24 gx-24">
                     <?php
                        $activity_query = "SELECT * FROM tb_activities WHERE status != 1 AND mc_id=1 ORDER BY activity_id ASC";
                     ...
                     <div class="col-md-4">
                        <div class="tour-box th-ani">
                           <div class="tour-box_img global-img"><img src="dynamic-images/activity/<?php echo $activity_image2; ?>" alt="image"></div>
