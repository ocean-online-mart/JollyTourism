            ...
            <div class="row flex-row-reverse align-items-center">
               ...
               <div class="col-lg-6">
                  <div class="error-content">
                     <h2 class="error-title">Thank You for Booking!</h2>
                     <h4 class="error-subtitle">BookingID - #JT31052500<?php echo $booking_id; ?></h4>
                     <p class="error-text">A confirmation email with all the details has been sent to you. If you have any questions or special requests, feel free to contact us.</p>
